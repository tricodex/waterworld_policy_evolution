        ...
        for agent in env.agent_iter():
            ...
            if termination or truncation:
                ...
                if model_name == "Heuristic":
                    ...
                    action = heuristic_policy(obs, n_sensors, sensor_range, len(env.possible_agents))
